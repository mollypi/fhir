...
func (m *MongoSearchSuite) TestConditionReferenceQueryObjectByPatientId(c *C) {
	...
	o := m.MongoSearcher.createQueryObject(q)
	c.Assert(o, DeepEquals, bson.M{
		"patient.referenceid": "4954037118555241963",
...
func (m *MongoSearchSuite) TestConditionReferenceQueryObjectByPatientTypeAndId(c *C) {
	...
	o := m.MongoSearcher.createQueryObject(q)
	c.Assert(o, DeepEquals, bson.M{"patient.referenceid": "4954037118555241963", "patient.type": "Patient"})
}
...
func (m *MongoSearchSuite) TestPatientNameStringQueryObject(c *C) {
	...
	c.Assert(o, DeepEquals, bson.M{
		"$or": []bson.M{
			{"name.text": bson.RegEx{Pattern: "^Peters", Options: "i"}},
			{"name.family": bson.RegEx{Pattern: "^Peters", Options: "i"}},
			{"name.given": bson.RegEx{Pattern: "^Peters", Options: "i"}},
		},
	})
}
...
func (m *MongoSearchSuite) TestPatientAddressStringQueryObject(c *C) {
	...
	c.Assert(o, DeepEquals, bson.M{
		"$or": []bson.M{
			{"address.text": bson.RegEx{Pattern: "^AK", Options: "i"}},
			{"address.line": bson.RegEx{Pattern: "^AK", Options: "i"}},
			{"address.city": bson.RegEx{Pattern: "^AK", Options: "i"}},
			{"address.state": bson.RegEx{Pattern: "^AK", Options: "i"}},
			{"address.postalCode": bson.RegEx{Pattern: "^AK", Options: "i"}},
			{"address.country": bson.RegEx{Pattern: "^AK", Options: "i"}},
		},
	})
}
...
func (m *MongoSearchSuite) TestValueQuantityQueryObjectByValueAndUnit(c *C) {
	...
	c.Assert(o, DeepEquals, bson.M{
		...
		"$or": []bson.M{
			{"valueQuantity.code": bson.RegEx{Pattern: "^lbs$", Options: "i"}},
			{"valueQuantity.unit": bson.RegEx{Pattern: "^lbs$", Options: "i"}},
		},
	})
}
...
func (m *MongoSearchSuite) TestConditionPatientAndCodeAndOnsetQueryObject(c *C) {
	...
	c.Assert(o["patient.referenceid"], DeepEquals, "4954037118555241963")
...
func (m *MongoSearchSuite) TestConditionMultiplePatientAndMultipleCodesQueryObject(c *C) {
	...
	expectedTopOr := []bson.M{
		...
		{
			"patient.referenceid": "123456789",
			"patient.type":        "Patient",
		},
		{
			"patient.referenceid": "ABCDEFG",
			"patient.type":        "Patient",
		},
	}
...
func (m *MongoSearchSuite) TestBuildBsonWithSingleOrCriteria(c *C) {
	b := buildBSON("a.b.c.d.e", bson.M{"$or": []bson.M{{"x": 1}, {"y": 2}}})
	c.Assert(b, DeepEquals, bson.M{
		"$or": []bson.M{
			{
				"a.b.c.d.e.x": 1,
...
func (m *MongoSearchSuite) TestBuildBsonWithAndOrCriteria(c *C) {
	b := buildBSON("a.b.c.d.e", bson.M{"z": 3, "$or": []bson.M{{"x": 1}, {"y": 2}}})
	c.Assert(b, DeepEquals, bson.M{
		"a.b.c.d.e.z": 3,
		"$or": []bson.M{
			{
...
func (m *MongoSearchSuite) TestBuildBsonWithAndComplexOrCriteria(c *C) {
	b := buildBSON("a.b.c.d.e", bson.M{"z": 3, "$or": []bson.M{{"x": 1, "a": 99}, {"y": 2}}})
	c.Assert(b, DeepEquals, bson.M{
		"a.b.c.d.e.z": 3,
		"$or": []bson.M{
			{
