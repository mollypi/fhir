...
var dateParamInfo = SearchParamInfo{
	Name:  "foo",
	Type:  "date",
	Paths: []SearchParamPath{{Path: "bar", Type: "date"}},
}
...
var numberParamInfo = SearchParamInfo{
	Name:  "foo",
	Type:  "number",
	Paths: []SearchParamPath{{Path: "bar", Type: "number"}},
}
...
var quantityParamInfo = SearchParamInfo{
	Name:  "foo",
	Type:  "quantity",
	Paths: []SearchParamPath{{Path: "bar", Type: "quantity"}},
}
...
var referenceParamInfo = SearchParamInfo{
	Name:    "foo",
	Type:    "reference",
	Paths:   []SearchParamPath{{Path: "bar", Type: "reference"}},
...
var stringParamInfo = SearchParamInfo{
	Name:  "foo",
	Type:  "string",
	Paths: []SearchParamPath{{Path: "bar", Type: "string"}},
}
...
var tokenParamInfo = SearchParamInfo{
	Name:  "foo",
	Type:  "token",
	Paths: []SearchParamPath{{Path: "bar", Type: "CodeableConcept"}},
}
...
var uriParamInfo = SearchParamInfo{
	Name:  "foo",
	Type:  "uri",
	Paths: []SearchParamPath{{Path: "bar", Type: "uri"}},
}
